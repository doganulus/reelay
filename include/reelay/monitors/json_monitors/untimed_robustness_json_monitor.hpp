...
struct untimed_robustness_json_monitor : base_monitor<TimeT, json, json> {
  using time_t = TimeT;
  ...
  untimed_robustness_json_monitor() = default;

  explicit untimed_robustness_json_monitor(const std::string &pattern,
