...
struct discrete_timed_data_condensing_json_monitor final
  ...
  discrete_timed_data_condensing_json_monitor() = default;

  explicit discrete_timed_data_condensing_json_monitor(
