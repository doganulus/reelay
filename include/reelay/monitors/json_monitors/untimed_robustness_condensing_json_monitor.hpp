...
struct untimed_robustness_condensing_json_monitor final
  ...
  untimed_robustness_condensing_json_monitor() = default;

  explicit untimed_robustness_condensing_json_monitor(
