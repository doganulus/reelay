...
template <typename TimeT, class FormatterT = discrete_timed_json_formatter<TimeT>>
struct untimed_data_json_monitor {
  using time_t = TimeT;
  using input_t = json;
  using output_t = json;
  ...
  untimed_data_json_monitor() = default;

  explicit untimed_data_json_monitor(
