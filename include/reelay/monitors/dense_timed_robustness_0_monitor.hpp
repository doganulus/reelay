...
struct dense_timed_robustness_0_monitor final
  ...
  using type = dense_timed_robustness_0_monitor<
      time_type, value_type, input_type, output_type>;

  using network_t
      = dense_timed_robustness_0_network<time_type, value_type, input_type>;
  using formatter_t
      = dense_timed_robustness_formatter<time_type, value_type, output_type>;

  dense_timed_robustness_0_monitor() = default;

  explicit dense_timed_robustness_0_monitor(
