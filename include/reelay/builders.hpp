...
struct ReelayTemporalLogicVisitor : public TemporalLogicBaseVisitor
{
    ...
    antlrcpp::Any visitProposition(TemporalLogicParser::PropositionContext *ctx) override
    {
    ...
    antlrcpp::Any visitBasicPredicateGT(TemporalLogicParser::BasicPredicateGTContext *ctx) override
    {
    ...
    antlrcpp::Any visitBasicPredicateGE(TemporalLogicParser::BasicPredicateGEContext *ctx) override
    {
        auto name = ctx->name->getText();
        float c = boost::lexical_cast<float>(ctx->constant->getText());
    ...
    antlrcpp::Any visitBasicPredicateLT(TemporalLogicParser::BasicPredicateLTContext *ctx) override
    {
        auto name = ctx->name->getText();
        float c = boost::lexical_cast<float>(ctx->constant->getText()); 
    ...
    antlrcpp::Any visitBasicPredicateLE(TemporalLogicParser::BasicPredicateLEContext *ctx) override
    {
        auto name = ctx->name->getText();
        float c = boost::lexical_cast<float>(ctx->constant->getText()); 
    ...
    antlrcpp::Any visitNamedPredicate(TemporalLogicParser::NamedPredicateContext *ctx) override
    {
        auto name = ctx->name->getText();
    ...
    antlrcpp::Any visitGrouping(TemporalLogicParser::GroupingContext *ctx) override
    {
        return this->visit(ctx->child);
    }
    ...
    antlrcpp::Any visitNegation(TemporalLogicParser::NegationContext *ctx) override
    {
    ...
    antlrcpp::Any visitDisjunction(TemporalLogicParser::DisjunctionContext *ctx) override
    {
    ...
    antlrcpp::Any visitConjunction(TemporalLogicParser::ConjunctionContext *ctx) override
    {
        auto left = this->visit(ctx->left);
        auto right = this->visit(ctx->right);
    ...
    antlrcpp::Any visitImplication(TemporalLogicParser::ImplicationContext *ctx) override
    {
        auto left = this->visit(ctx->left);
        auto right = this->visit(ctx->right);
    ...
    antlrcpp::Any visitSometimeP(TemporalLogicParser::SometimePContext *ctx) override
    {
        auto child = this->visit(ctx->child);
    ...
    antlrcpp::Any visitAlwaysP(TemporalLogicParser::AlwaysPContext *ctx) override
    {
        auto child = this->visit(ctx->child);
    ...
    antlrcpp::Any visitTimedSometimeP(TemporalLogicParser::TimedSometimePContext *ctx) override
    {
        auto child = this->visit(ctx->child);
    ...
    antlrcpp::Any visitTimedAlwaysP(TemporalLogicParser::TimedAlwaysPContext *ctx) override
    {
        auto child = this->visit(ctx->child);
    ...
    antlrcpp::Any visitTimedSince(TemporalLogicParser::TimedSinceContext *ctx) override
    {
        auto left = this->visit(ctx->left);
        auto right = this->visit(ctx->right);
    ...
    antlrcpp::Any visitLowerBound(TemporalLogicParser::LowerBoundContext *ctx) override
    {
    ...
    antlrcpp::Any visitUpperBound(TemporalLogicParser::UpperBoundContext *ctx) override
    {
        time_t lbound = 0;
    ...
    antlrcpp::Any visitBothBound(TemporalLogicParser::BothBoundContext *ctx) override
    {
        time_t lbound = std::stoi(ctx->l->getText()); //See boost::lexical_cast
        time_t ubound = std::stoi(ctx->u->getText()); //See boost::lexical_cast
...
class MyParserErrorListener : public antlr4::BaseErrorListener
{
    ...
    {
        // std::ostrstream s;
        // std::cerr << "Line(" << line << ":" << charPositionInLine << ") Error(" << msg << ")";
