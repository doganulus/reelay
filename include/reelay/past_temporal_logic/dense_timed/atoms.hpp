...
struct proposition : public dense_timed_state<X, interval_set<T>, T>
{
    ...
    using function_t = std::function<output_t(const input_t &, const input_t &, time_t, time_t)>;
    ...
    proposition(std::string name) 
        : fn([name](const input_t &pargs, const input_t &args, time_t previous, time_t now) {
...
struct basic_predicate_lt : public dense_timed_state<X, interval_set<T>, T>
{
    ...
    basic_predicate_lt(std::string name, float c)
        : fn( [name,c](const input_t &, const input_t &, time_t, time_t) { return interval_set();}) {}
