...
struct past_sometime_bounded_half : public dense_timed_state<X, interval_set<T>, T>
{
    using time_t = T;
    using input_t = X;
    ...
    past_sometime_bounded_half(std::vector<node_ptr_t> args, time_t l) : first(args[0]), lbound(l) {}
