...
struct past_sometime_bounded : public discrete_timed_state<X, bool, T>
{
    using time_t = T;
    using input_t = X;
    using output_t = bool;
    ...
    past_sometime_bounded(std::vector<node_ptr_t> args, time_t l, time_t u) : first(args[0]), lbound(l), ubound(u) {}
