...
def test_integration_discrete_timed_past_mtl():
    ...
    expected = [{'time': 3.4, 'value': False}, {'time': 6.4, 'value': False}, {'time': 8.7, 'value': False}, {'time': pytest.approx(10.5, 0.001), 'value': False}, {'time': pytest.approx(19.6, 0.001), 'value': True}, {'time': 23.1, 'value': False}, {'time': 33.2, 'value': False}, {'time': 36.4, 'value': False}, {'time': 38.7, 'value': False}, {'time': 39.2, 'value': False}]
