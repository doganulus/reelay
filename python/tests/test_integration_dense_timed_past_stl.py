...
def test_integration_dense_timed_past_stl():
    ...
    expected = [{'time': pytest.approx(0.02137,0.001), 'value': False}, {'time': 0.03, 'value': True}, {'time': 0.06, 'value': True}, {'time': 0.08, 'value': True}, {'time': pytest.approx(0.2152, 0.001), 'value': True}, {'time': 0.23, 'value': False}, {'time': 0.33, 'value': False}, {'time': 0.36, 'value': False}, {'time': 0.38, 'value': False}, {'time': 0.39, 'value': False}]
