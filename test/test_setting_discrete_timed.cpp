...
TEST_CASE( "Untimed Temporal Operations" ) {
    ...
    SECTION( "Past Always" ) {
        ...
        auto net1 = reelay::discrete_timed<int>::monitor<input_t>::from_temporal_logic("historically p1");
        auto net2 = reelay::discrete_timed<int>::monitor<input_t>::from_temporal_logic("historically p2");
