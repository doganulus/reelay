...
TEST_CASE("Atoms") {
  ...
  SECTION("LessThanFirstOrder 1") {
    ...
    auto net1 =
        reelay::dense_timed<dense_time_t,
                            1>::monitor<input_t>::from_temporal_logic("x1 < 5");
