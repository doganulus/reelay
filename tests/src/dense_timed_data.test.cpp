  ...
  "[dense_timed_data]")
{
  ...
  SECTION("Proposition_ZeroHoldForward")
  {
    ...
    sequence.push_back(input_type{{"time", 31}});
    sequence.push_back(input_type{{"time", 33}, {"x1", false}});
    sequence.push_back(input_type{{"time", 35}, {"x1", false}});
    sequence.push_back(input_type{{"time", 40}});
    sequence.push_back(input_type{{"time", 52}, {"x1", true}});
    sequence.push_back(input_type{{"time", 55}});

    auto net1 = reelay::dense_timed_data_network<time_type, input_type>::make(
      "{x1}", opts);
  ...
  SECTION("AtomicString_ZeroHoldForward")
  {
    ...
    sequence.push_back(input_type{{"time", 31}});
    sequence.push_back(input_type{{"time", 33}, {"x1", "fortuna"}});
    sequence.push_back(input_type{{"time", 35}, {"x1", "fortuna"}});
    sequence.push_back(input_type{{"time", 40}});
    sequence.push_back(input_type{{"time", 52}, {"x1", "veritas"}});
    sequence.push_back(input_type{{"time", 55}});
  ...
  SECTION("AtomicNumber_ZeroHoldForward")
  {
    ...
    sequence.push_back(input_type{{"time", 31}});
    sequence.push_back(input_type{{"time", 33}, {"x1", 11}});
    sequence.push_back(input_type{{"time", 35}, {"x1", 12.5}});
    sequence.push_back(input_type{{"time", 40}});
    sequence.push_back(input_type{{"time", 52}, {"x1", 12.5}});
    sequence.push_back(input_type{{"time", 55}});
  ...
  SECTION("LessThan_ZeroHoldForward")
  {
    ...
    sequence.push_back(input_type{{"time", 31}, {"x1", 3}});
    sequence.push_back(input_type{{"time", 33}, {"x1", 5}});
    sequence.push_back(input_type{{"time", 35}, {"x1", 4}});
    sequence.push_back(input_type{{"time", 40}});
  ...
  SECTION("Record Proposition 2")
  {
    ...
    sequence.push_back(input_type{
      ...
      {"file", "wonderland"}});
    sequence.push_back(
      input_type{{"time", 9}, {"event", "access"}, {"user", "charlotte"}});
    sequence.push_back(input_type{{"time", 11}});
  ...
  SECTION("Record Proposition 2")
  {
    ...
    sequence.push_back(
      input_type{{"time", 0}, {"event", "access"}, {"user", "alice"}});
    sequence.push_back(
      input_type{{"time", 3}, {"event", "access"}, {"user", "bob"}});
    sequence.push_back(input_type{
      {"time", 6},
      {"event", "access"},
      {"user", "charlotte"},
  ...
  SECTION("Record Proposition")
  {
    ...
    sequence.push_back(
      input_type{{"time", 0}, {"event", "access"}, {"user", "alice"}});
    sequence.push_back(
      input_type{{"time", 3}, {"event", "access"}, {"file", "wonderland"}});
    sequence.push_back(input_type{
      {"time", 6},
      {"event", "access"},
      {"user", "charlotte"},
...
TEST_CASE(  // NOLINT(readability-function-cognitive-complexity)
  "Dense Timed Data Boolean Operations",
  "[dense_timed_data]")
{
  auto manager = std::make_shared<reelay::binding_manager>();
  auto opts = reelay::basic_options().with_data_manager(manager);
  ...
  SECTION("Conjunction")
  {
    ...
    sequence.push_back(input_type{
      ...
      {"file", "wonderland"}});
    sequence.push_back(
      input_type{{"time", 6}, {"event", "logout"}, {"user", "alice"}});
    sequence.push_back(input_type{{"time", 10}});
...
TEST_CASE(  // NOLINT(readability-function-cognitive-complexity)
  "Dense Timed Data Temporal Operations (Untimed)",
  "[dense_timed_data]")
{
  auto manager = std::make_shared<reelay::binding_manager>();
  auto opts = reelay::basic_options().with_data_manager(manager);
  SECTION("Once")
  {
    ...
    sequence.push_back(
      input_type{{"time", 0}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 4}, {"state", "open"}, {"arg1", "c"}});
    sequence.push_back(
      input_type{{"time", 6}, {"state", "close"}, {"arg1", "c"}});
    sequence.push_back(
      input_type{{"time", 7}, {"state", "close"}, {"arg1", "a"}});
    sequence.push_back(input_type{{"time", 9}});
  ...
  SECTION("Historically")
  {
    ...
    sequence.push_back(
      input_type{{"time", 0}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 4}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 6}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 7}, {"state", "close"}, {"arg1", "c"}});
    sequence.push_back(input_type{{"time", 9}});
  ...
  SECTION("Since")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"state", "arrived"}});
    sequence.push_back(
      input_type{{"time", 1}, {"state", "open"}, {"arg1", "b"}});
    sequence.push_back(
      input_type{{"time", 4}, {"state", "open"}, {"arg1", "c"}});
    sequence.push_back(
      input_type{{"time", 6}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(input_type{{"time", 7}, {"state", "close"}});
    sequence.push_back(input_type{{"time", 9}});
  ...
  SECTION("Since")
  {
    ...
    sequence.push_back(
      input_type{{"time", 0}, {"state", "arrived"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 1}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 4}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 6}, {"state", "open"}, {"arg1", "a"}});
  ...
  SECTION("Since")
  {
    ...
    sequence.push_back(input_type{{"time", 0}});
    sequence.push_back(input_type{
      {"time", 3},
      {"visitor1", "alice"},
      {"visitor2", "charlotte"},
...
TEST_CASE(  // NOLINT(readability-function-cognitive-complexity)
  "Dense Timed Data Temporal Operations (Bounded)",
  "[dense_timed_data]")
{
  auto manager = std::make_shared<reelay::binding_manager>();
  auto opts = reelay::basic_options().with_data_manager(manager);
  SECTION("Timed Once")
  {
    ...
    sequence.push_back(
      input_type{{"time", 0}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 1}, {"state", "open"}, {"arg1", "c"}});
    sequence.push_back(
      input_type{{"time", 3}, {"state", "close"}, {"arg1", "c"}});
    sequence.push_back(
      input_type{{"time", 6}, {"state", "close"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 7}, {"state", "close"}, {"arg1", "c"}});
    sequence.push_back(
      input_type{{"time", 9}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 12}, {"state", "close"}, {"arg1", "c"}});
    sequence.push_back(input_type{{"time", 17}});
  ...
  SECTION("Timed Historically")
  {
    ...
    sequence.push_back(
      input_type{{"time", 0}, {"state", "open"}, {"arg1", "b"}});
    sequence.push_back(
      input_type{{"time", 1}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 3}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 4}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 7}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 11}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(
      input_type{{"time", 12}, {"state", "close"}, {"arg1", "a"}});
  ...
  SECTION("Timed Historically")
  {
    ...
    sequence.push_back(
      input_type{{"time", 11}, {"state", "open"}, {"arg1", "a"}});
    sequence.push_back(input_type{{"time", 12}, {"state", "close"}});
    sequence.push_back(input_type{{"time", 19}});
  ...
  SECTION("Timed Since")
  {
    ...
    sequence.push_back(input_type{
      ...
      {"visiting2", "charlotte"},
      {"where", "wonderland"}});
    sequence.push_back(input_type{{"time", 21}});
  ...
  SECTION("Timed Since Inf")
  {
    ...
    sequence.push_back(input_type{{"time", 23}});
