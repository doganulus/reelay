...
using robustness_map = reelay::robustness_interval_map<time_type, value_type>;

TEST_CASE(  // NOLINT(readability-function-cognitive-complexity)
  "Dense Timed Robustness Atoms",
  "[dense_timed_robustness]")
{
  ...
  SECTION("Proposition")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", 11}});
    sequence.push_back(input_type{{"time", 10}, {"x", 15}});
    sequence.push_back(input_type{{"time", 20}, {"x", 13}});
    sequence.push_back(input_type{{"time", 42}});

    auto net1 = reelay::
      dense_timed_robustness_0_network<time_type, value_type, input_type>::make(
        "{x}");
  ...
  SECTION("GreaterEqual")
  {
    ...
    sequence.push_back(input_type{{"time", 1}, {"x1", 5}});
    sequence.push_back(input_type{{"time", 6}, {"x1", 4}});
    sequence.push_back(input_type{{"time", 9}});
  ...
  SECTION("InBetween_ZeroHoldForward")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x1", 3}});
    sequence.push_back(input_type{{"time", 1}, {"x1", 3}});
    sequence.push_back(input_type{{"time", 3}, {"x1", 6}});
    sequence.push_back(input_type{{"time", 5}, {"x1", 4}});
    sequence.push_back(input_type{{"time", 7}});
  ...
  SECTION("AtomicTrue")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", true}});
    sequence.push_back(input_type{{"time", 10}, {"x", false}});
    sequence.push_back(input_type{{"time", 20}, {"x", true}});
    sequence.push_back(input_type{{"time", 42}});
  ...
  SECTION("AtomicString")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", "hello"}});
    sequence.push_back(input_type{{"time", 10}, {"x", "world"}});
    sequence.push_back(input_type{{"time", 20}, {"x", "alice"}});
    sequence.push_back(input_type{{"time", 42}});
  ...
  SECTION("AtomicNumber")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", 555}});
    sequence.push_back(input_type{{"time", 10}, {"x", 666}});
    sequence.push_back(input_type{{"time", 20}, {"x", 777}});
    sequence.push_back(input_type{{"time", 42}});
  ...
  SECTION("AtomicAny")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", 555}});
    sequence.push_back(input_type{{"time", 10}});
    sequence.push_back(input_type{{"time", 20}, {"x", 777}});
    sequence.push_back(input_type{{"time", 42}});
...
TEST_CASE(  // NOLINT(readability-function-cognitive-complexity)
  "Dense Timed Robustness Boolean Operations",
  "[dense_timed_robustness]")
{
  value_type top = reelay::infinity<value_type>::value();
  value_type bot = -reelay::infinity<value_type>::value();
  ...
  SECTION("Disjunction")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", 11}, {"y", 10}});
    sequence.push_back(input_type{{"time", 10}, {"x", 15}, {"y", 12}});
    sequence.push_back(input_type{{"time", 20}, {"x", 13}, {"y", 17}});
    sequence.push_back(input_type{{"time", 42}});
...
TEST_CASE(  // NOLINT(readability-function-cognitive-complexity)
  "Dense Timed Robustness Temporal Operations (Untimed)",
  "[dense_timed_robustness]")
{
  value_type top = reelay::infinity<value_type>::value();
  value_type bot = -reelay::infinity<value_type>::value();
  ...
  SECTION("Past Always")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", -11}, {"y", 10}});
    sequence.push_back(input_type{{"time", 10}, {"x", -15}, {"y", 9}});
    sequence.push_back(input_type{{"time", 20}, {"x", -13}, {"y", 7}});
    sequence.push_back(input_type{{"time", 42}});
  ...
  SECTION("Since")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", 3}, {"y", 0}});
    sequence.push_back(input_type{{"time", 1}, {"x", 4}, {"y", 1}});
    sequence.push_back(input_type{{"time", 2}, {"x", 5}, {"y", 0}});
    sequence.push_back(input_type{{"time", 3}, {"x", 1}, {"y", 0}});
    sequence.push_back(input_type{{"time", 4}, {"x", -3}, {"y", 0}});
    sequence.push_back(input_type{{"time", 5}, {"x", -1}, {"y", 0}});
    sequence.push_back(input_type{{"time", 6}, {"x", 1}, {"y", 0}});
    sequence.push_back(input_type{{"time", 7}, {"x", 4}, {"y", 1}});
    sequence.push_back(input_type{{"time", 8}, {"x", -1}, {"y", 0}});
    sequence.push_back(input_type{{"time", 9}, {"x", 1}, {"y", 0}});
    sequence.push_back(input_type{{"time", 10}, {"x", 6}, {"y", 0}});
    sequence.push_back(input_type{{"time", 11}, {"x", 1}, {"y", 0}});
    sequence.push_back(input_type{{"time", 12}, {"x", 1}, {"y", 5}});
    sequence.push_back(input_type{{"time", 13}, {"x", 1}, {"y", 0}});
    sequence.push_back(input_type{{"time", 14}});
...
TEST_CASE(  // NOLINT(readability-function-cognitive-complexity)
  "Dense Timed Robustness Temporal Operations (Bounded)",
  "[dense_timed_robustness]")
{
  value_type top = reelay::infinity<value_type>::value();
  value_type bot = -reelay::infinity<value_type>::value();
  ...
  SECTION("Timed Past Always")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", 11}});
    sequence.push_back(input_type{{"time", 10}, {"x", 9}});
    sequence.push_back(input_type{{"time", 20}, {"x", 13}});
    sequence.push_back(input_type{{"time", 30}, {"x", 17}});
    sequence.push_back(input_type{{"time", 60}, {"x", 15}});
    sequence.push_back(input_type{{"time", 70}, {"x", 4}});
    sequence.push_back(input_type{{"time", 90}});

    auto net1 = reelay::
      dense_timed_robustness_0_network<time_type, value_type, input_type>::make(
        "historically[12:24]{x}");
  ...
  SECTION("Timed Since 2")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", -3}, {"y", -6}});
    sequence.push_back(input_type{{"time", 10}, {"x", -4}, {"y", 1}});
    sequence.push_back(input_type{{"time", 20}, {"x", -5}, {"y", -8}});
    sequence.push_back(input_type{{"time", 30}, {"x", 15}, {"y", 3}});
    sequence.push_back(input_type{{"time", 40}, {"x", -3}, {"y", 22}});
    sequence.push_back(input_type{{"time", 50}});
  ...
  SECTION("Timed Since Inf")
  {
    ...
    sequence.push_back(input_type{{"time", 0}, {"x", -3}, {"y", -6}});
    sequence.push_back(input_type{{"time", 1}, {"x", -4}, {"y", 1}});
    sequence.push_back(input_type{{"time", 2}, {"x", -5}, {"y", -8}});
    sequence.push_back(input_type{{"time", 3}, {"x", 15}, {"y", 3}});
    sequence.push_back(input_type{{"time", 4}, {"x", -3}, {"y", 22}});
    sequence.push_back(input_type{{"time", 5}});
